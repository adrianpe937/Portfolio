    ...
    >
      ...
      <footer className="footer">
        <div className="footer-links">
          ...
          <a href="https://www.linkedin.com/in/adri%C3%A1n-pe%C3%B1a-p%C3%A9rez-b8b960296/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
        </div>
        <div className="footer-social">
          ...
          <a href="https://www.linkedin.com/in/adri%C3%A1n-pe%C3%B1a-p%C3%A9rez-b8b960296/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
